...
from Mini_lex_PHP import tokens 
import Mini_lex_PHP
import sys
...
def p_program(p):
	'program : header header_declaration declaration_list footer_declaration'
	pass
...
def p_header(p):
    'header : LESS QUESTIONMARK PHP'
    pass

def p_header_declaration(p):
    '''header_declaration : INCLUDE SEMICOLON
    						| empty_function '''
    pass
...
def p_show_in_screen_3(p):
    'show_in_screen : ECHO COMILLASDOBLES var_val COMILLASDOBLES SEMICOLON'
    pass
def p_show_in_screen_3(p):
